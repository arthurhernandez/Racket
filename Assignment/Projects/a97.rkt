...
;Change all of your (define name (lambda () ...)) statements to instead
;use define-label. Define your program counter at the top of the program
;using define-program-counter.

(define-program-counter programcCounter)
